...
export type AnswerDiscriminatorInput = {
  ...
  answerStarRate?: InputMaybe<AnswerStarRateInput>;
...
export type AnswerStarRate = Answer & {
  __typename?: 'AnswerStarRate';
  answeredAt?: Maybe<Scalars['DateTime']['output']>;
  correct?: Maybe<Scalars['Boolean']['output']>;
  question: Scalars['String']['output'];
...
export type AnswerStarRateInput = {
  answeredAt?: InputMaybe<Scalars['DateTime']['input']>;
  questionId: Scalars['String']['input'];
...
export type QuestionDiscriminatorInput = {
  ...
  questionStarRate?: InputMaybe<QuestionStarRateInput>;
...
export type QuestionStarRate = Question & {
  __typename?: 'QuestionStarRate';
  _id: Scalars['String']['output'];
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  feedbackAfterSubmit?: Maybe<Scalars['String']['output']>;
...
export type QuestionStarRateInput = {
  description?: InputMaybe<Scalars['String']['input']>;
  feedbackAfterSubmit?: InputMaybe<Scalars['String']['input']>;
  required?: InputMaybe<Scalars['Boolean']['input']>;
  showCorrectAnswer?: InputMaybe<Scalars['Boolean']['input']>;
...
export type QuestionStarRateMetrics = QuestionMetrics & {
  __typename?: 'QuestionStarRateMetrics';
  _id: Scalars['String']['output'];
  answerCount: Scalars['Int']['output'];
...
export type CreateQuizMutation = { __typename?: 'Mutation', adminCreateQuestionnaireQuiz: { __typename?: 'QuestionnaireQuiz', _id: string, sharedId: string, type: QuestionnaireType, requireEmail: boolean, requireName: boolean, title: string, description: string, active: boolean, color?: string | null, bgColor?: string | null, sharedCreatedAt: Date, createdAt: Date, updatedAt: Date, metrics: { __typename?: 'QuestionnaireMetrics', _id: string, totalResponseCount: number, totalAttemptCount: number, totalAnswerTime: number, avgAnswerTime: number, avgAttemptCount: number, byLocationMap?: string | null, questionMetrics: Array<{ __typename?: 'QuestionMultipleChoiceMetrics', _id: string, answerCount: number, unansweredCount: number, rightAnswerCount: number, wrongAnswerCount: number, options: Array<{ __typename?: 'OptionMetrics', _id: string, selectedCount: number }> } | { __typename?: 'QuestionSingleChoiceMetrics', _id: string, answerCount: number, unansweredCount: number, rightAnswerCount: number, wrongAnswerCount: number, options: Array<{ __typename?: 'OptionMetrics', _id: string, selectedCount: number }> } | { __typename?: 'QuestionStarRateMetrics', _id: string, answerCount: number, unansweredCount: number, avgRate?: number | null } | { __typename?: 'QuestionTextMetrics', _id: string, answerCount: number, unansweredCount: number } | { __typename?: 'QuestionTrueOrFalseMetrics', _id: string, answerCount: number, unansweredCount: number, rightAnswerCount: number, wrongAnswerCount: number, options: Array<{ __typename?: 'OptionMetrics', _id: string, selectedCount: number }> }> }, questions: Array<{ __typename?: 'QuestionMultipleChoice', _id: string, type: QuestionType, showCorrectAnswer: boolean, title?: string | null, weight?: number | null, required: boolean, description?: string | null, wrongAnswerFeedback?: string | null, rightAnswerFeedback?: string | null, randomizeOptions: boolean, options: Array<{ __typename?: 'Option', _id: string, title: string, correct?: boolean | null, true?: boolean | null, feedbackAfterSubmit?: string | null }> } | { __typename?: 'QuestionSingleChoice', _id: string, type: QuestionType, showCorrectAnswer: boolean, title?: string | null, weight?: number | null, required: boolean, description?: string | null, wrongAnswerFeedback?: string | null, rightAnswerFeedback?: string | null, randomizeOptions: boolean, options: Array<{ __typename?: 'Option', _id: string, title: string, correct?: boolean | null, true?: boolean | null, feedbackAfterSubmit?: string | null }> } | { __typename?: 'QuestionStarRate', _id: string, type: QuestionType, showCorrectAnswer: boolean, title?: string | null, weight?: number | null, required: boolean, description?: string | null, feedbackAfterSubmit?: string | null } | { __typename?: 'QuestionText', _id: string, type: QuestionType, showCorrectAnswer: boolean, title?: string | null, weight?: number | null, required: boolean, description?: string | null, feedbackAfterSubmit?: string | null } | { __typename?: 'QuestionTrueOrFalse', _id: string, type: QuestionType, showCorrectAnswer: boolean, title?: string | null, weight?: number | null, required: boolean, description?: string | null, wrongAnswerFeedback?: string | null, rightAnswerFeedback?: string | null, options: Array<{ __typename?: 'Option', _id: string, title: string, correct?: boolean | null, true?: boolean | null, feedbackAfterSubmit?: string | null }> }> } };
...
export type QuestionStarRateFragmentFragment = { __typename?: 'QuestionStarRate', _id: string, type: QuestionType, showCorrectAnswer: boolean, title?: string | null, weight?: number | null, required: boolean, description?: string | null, feedbackAfterSubmit?: string | null };
...
export const QuestionTextFragmentFragmentDoc = gql`
  ...
  feedbackAfterSubmit
    ...
    `;
export const QuestionStarRateFragmentFragmentDoc = gql`
...
${QuestionStarRateFragmentFragmentDoc}`;
